...
$quiz = array(
    ...
    array(
        ...
        "correct_answer" => "Repite un bloque de código un número fijo de veces."
    ),
    array(
        ...
        "correct_answer" => "Una técnica que utiliza funciones para llamarse a sí mismas."
    ),
    array(
        ...
        "correct_answer" => "Un lenguaje que permite la abstracción y portabilidad de código."
    ),
    array(
    ...
    array(
        ...
        "correct_answer" => "Un Entorno de Desarrollo Integrado."
    ),
    array(
    ...
    array(
        ...
        "correct_answer" => "Compara dos valores para igualdad."
    ),
    array(
        ...
        "correct_answer" => "Un algoritmo que organiza elementos en una lista en un orden específico."
    ),
    array(
        ...
        "correct_answer" => "Un paradigma de programación que utiliza objetos y clases."
    )
);
